...
// MockTikTokClient is an alias to the shared mock in clients/social package.
// This allows services to use the common mock for testing TikTok API operations.
type MockTikTokClient = social.MockTikTokClient
...
// NewMockTikTokClient creates a new mock TikTok client for testing
func NewMockTikTokClient() *MockTikTokClient {
