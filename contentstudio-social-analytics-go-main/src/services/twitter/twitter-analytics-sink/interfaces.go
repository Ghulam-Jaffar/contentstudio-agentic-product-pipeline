...
// ClickHouseSinkInterface defines the interface for Twitter-specific ClickHouse operations.
// This interface combines storage methods specific to the Twitter analytics sink.
