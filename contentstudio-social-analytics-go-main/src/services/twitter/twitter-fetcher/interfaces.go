...
// This allows services to use the common interface for Twitter API operations.
type TwitterAPI = social.TwitterAPI

// Verify that TwitterClient implements TwitterAPI
var _ TwitterAPI = (*social.TwitterClient)(nil)
