...
// MockTwitterClient is an alias to the shared mock in clients/social package.
// This allows services to use the common mock for testing Twitter API operations.
type MockTwitterClient = social.MockTwitterClient
...
// NewMockTwitterClient creates a new mock Twitter client for testing
func NewMockTwitterClient() *MockTwitterClient {
